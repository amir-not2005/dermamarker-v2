...
def causes():
    ...
    if request.method == "POST":
        ...
        if file_extension not in [".jpg", ".png", ".jpeg"]:
            ...
            return render_template('causes.html', irrelevantImage=irrelevantImage, form=form, x=x, x1=x1, x2=x2,d1=d1,da1=da1,im1=im1,imp1=imp1,maxdt=maxdt,it1=it1,imt1=imt1,dt=dt,pm=pm)
...
def save_form():
    ...
    c.execute("INSERT INTO form_table (name, email, subject, message) VALUES (?, ?, ?, ?)",
