...
def save_analytics_db(form_data):
    ...
    # Insert the form_data into the table
    c.execute("""
        INSERT INTO analytics (name, email, phone, age, gender, howKnow, message)
        VALUES (?, ?, ?, ?, ?, ?, ?)
    """, (form_data['name'], form_data['email'], form_data['phone'], form_data['age'], form_data['gender'], form_data['howKnow'], form_data['message']))
